...
$(document).ready(function() {
	...
	$(".owl_content").owlCarousel({
		...
		afterAction: function (el) {
			...
			$('.active').eq(middle_item - 1).addClass('middle_beside').addClass('prev_mid');
			$('.active').eq(middle_item).addClass('middle');
			$('.active').eq(middle_item + 1).addClass('middle_beside').addClass('next_mid');
			...
			if ($('.owl-item').last().hasClass('active')) {
				$(".owl_content").data('owlCarousel').reinit();
			}
		}
	});
